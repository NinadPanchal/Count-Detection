...
export const metadata: Metadata = {
  title: "CrowdSense AI — See the Crowd. Prevent the Chaos.",
  description: "AI-powered real-time crowd management, density monitoring & predictive analytics command center",
};
